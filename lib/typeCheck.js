...
const checkFieldType = ({ type, fieldName, value, required, multiple }) => __awaiter(this, void 0, void 0, function* () {
    let error = '';
...
const shape = model => (valueObject) => __awaiter(this, void 0, void 0, function* () {
...
module.exports = Object.assign({ checkFieldType }, simpleTypes, { relation,
    shape });
